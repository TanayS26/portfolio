...
export class ClientAppsComponent implements OnInit {
  ...
  _mClientApps = [
    ...
    {
     "id": "5131",
     "name": "cTrunk: Courrier Management Software",
     "image": "assets/img/clients/pepplus.png",
     "link": "https://ctrunk.com/",
     "tab": "Android",
     "color": "#FFFFFF"
   },
   ...
   {
     "id": "5132",
     "name": "Vani: VFX & Animation Management Software",
     "image": "assets/img/clients/whichone.png",
     "link": "https://www.vanisoftware.com/",
     "tab": "Flutter"
   },
  //  {
  //    "id": "5133",
  //    "name": "Ravkoo Health: Digital Healthcare Marketplace ",
  //    "image": "assets/img/clients/aabboo.png",
  //    "link": "https://ravkoohealth.com/",
  //    "tab": "Android"
  //  }
  ];
}
